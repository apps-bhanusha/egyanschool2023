...
//
//     final noticModel = noticModelFromJson(jsonString);

import 'dart:convert';

NoticModel? noticModelFromJson(String str) => NoticModel.fromJson(json.decode(str));

String noticModelToJson(NoticModel data) => json.encode(data.toJson());
