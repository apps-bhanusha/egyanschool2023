...
class _StudentAddUserDialogDialogState extends State<StudentAddUserDialog>
    with SingleTickerProviderStateMixin {
  StudentLeaveRecordController StudentLeaveRecord =
      Get.put(StudentLeaveRecordController());
  StudentAddLeaveController AddStudentLeaveRecord =
      Get.put(StudentAddLeaveController());
  var pickedRange1;
  var pickedRange2;
  var from_date;
  var to_date;
