      ...
      //         ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
             Text("Class",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
             Text("Section",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
             Text("HomeWork Date",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
             Text("Submission Date",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
             Text("Evalution Date",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
             Text("Subject Group",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
