...
Get.put(GetSchoolSettingController());
  ...
  Widget build(BuildContext context) {
    ...
    FeesWidget(total_balance_amount: all.FeeControllerList[0]["response"]["total_balance_amount"].toString(), 
    total_amount: all.FeeControllerList[0]["response"]["total_amount"].toString(),
     ...
     profileimage: studentProfileController.studentProfileModel.value?.response.profileimage,
      ...
      section: studentProfileController.studentProfileModel.value?.response.section,
       total_discount_amount:  all.FeeControllerList[0]["response"]["total_discount_amount"].toString(), 
       total_deposite_amount:  all.FeeControllerList[0]["response"]["total_deposite_amount"].toString(),
        total_fine_amount: all.FeeControllerList[0]["response"]["total_fine_amount"].toString()
        )
