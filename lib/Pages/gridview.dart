...
class _GridViewallState extends State<GridViewall> with TickerProviderStateMixin{
  ...
  void initState() {
    super.initState();
    _controller = AnimationController(duration: const Duration(seconds: 1), vsync: this,lowerBound: 0.3,);
 ...
 // final Tween<double> _scaleTween=Tween<double>(begin:1,end:2);
  ...
  final trailing = ["Home", "Profile","Attendance", "Fees","Examination","HomeWork", "Download", "Homework","Download center","Chat"];
  final icons1= [Icon(
    Icons.home,
    size: 25,
    color:  Colors.red,
...
elevation: 10,
                       ...
                       shape: RoundedRectangleBorder(
                           ...
                           side: BorderSide(width: 5, color:color2[index],)),
                       color: color2[index],
                       child: Column(
...
height: 0.055.sh,
                           ...
                           Padding(
                             ...
                             child: Container(child:  Text(trailing[index],
                               style: GoogleFonts.dmSans(
                                   fontStyle: FontStyle.normal,
                                   fontSize: 15.sp,
                                   fontWeight: FontWeight.bold,
